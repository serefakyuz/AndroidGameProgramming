 ...
 *
 */
public class ResimDondurme  extends BaseGameActivity 
{
	...
	public void onLoadResources() {
		...
		texRegRedWins = TextureRegionFactory.createFromAsset(texBlueWins, this, "gfx/redwins.png", 0, 0);
		texRegBlueWins = TextureRegionFactory.createFromAsset(texRedWins, this, "gfx/bluewins.png", 0, 0);
	...
	public Scene onLoadScene() 
	{
		...
		spriteRedWins = new Sprite(CAMERA_WIDTH/2 - 100, CAMERA_HEIGHT/2 - 128, texRegRedWins);
		spriteBlueWins = new Sprite(CAMERA_WIDTH/2 + 32, CAMERA_HEIGHT/2 - 128, texRegBlueWins.clone());
		spriteBlueWins.setVisible(false);
		
		//Zamanlayıcı(timer) oluşturuluyor
		mEngine.registerUpdateHandler(timerBeklet = new TimerHandler(3, false, new ITimerCallback() 
		{
			...
			public void onTimePassed(TimerHandler pTimerHandler) 
			{
				...
				//Zamanlay�c�(timer) olu�turuluyor
				mEngine.registerUpdateHandler(timerBeklet = new TimerHandler(3, false, new ITimerCallback() 
				{
					@Override
					public void onTimePassed(TimerHandler pTimerHandler) 
