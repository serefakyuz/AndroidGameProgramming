 ...
 *
 */
public class DokunmatikEkranKullanimiSpriteMetodlari extends BaseGameActivity 
{
	...
	public Scene onLoadScene() 
	{
		...
		// SpriteOyuncu1 olu�turuluyor. ��eri�inde dokunma durumunu yakalayan kod blo�u bulunmakta.
		spriteOyuncu1 = new Sprite(600, CAMERA_HEIGHT/2 - 64, texRegOyuncu1)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				...
				{
					// PArmak dokundu�unda sprite g�r�nmez olur
					spriteOyuncu1.setVisible(false);
				}
				if(pSceneTouchEvent.isActionMove())
				{
					spriteOyuncu1.setPosition(pSceneTouchEvent.getX() - this.getWidth()/2, pSceneTouchEvent.getY()- this.getHeight()/2);
				}
				if(pSceneTouchEvent.isActionUp())
				{
					// parmak ekrandan �ekildi�inde sprite tekrar g�r�n�r
					spriteOyuncu1.setVisible(true);
				}
				return true;
			}
		};
		...
		spriteOyuncu2 = new Sprite(50, CAMERA_HEIGHT/2 - 64, texRegOyuncu2)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				...
				{
					// PArmak dokundu�unda sprite g�r�nmez olur
					spriteOyuncu2.setVisible(false);
				}
				if(pSceneTouchEvent.isActionMove())
				{
