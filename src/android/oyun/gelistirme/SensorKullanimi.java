 ...
 *
 */
public class SensorKullanimi  extends BaseGameActivity implements IAccelerometerListener
{
	...
	public void onLoadResources() 
	{
		...
		texRegOyuncu2 = TextureRegionFactory.createFromAsset(texOyuncu1, this, "gfx/kol2.png", 0, 0);
	...
	public Scene onLoadScene() 
	{
		...
		// Sens�rler etkin hale getiriliyor
	...
	// IAccelerometerListener interface' inin sağladığı metot
	@Override
	public void onAccelerometerChanged(AccelerometerData pAccelerometerData) 
	{
		final Vector2 yerCekimi = Vector2Pool.obtain(
				pAccelerometerData.getX(), pAccelerometerData.getY());
		this.physicsWorld.setGravity(yerCekimi);
		Vector2Pool.recycle(yerCekimi);
	}
