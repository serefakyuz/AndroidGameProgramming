 ...
 *
 */
public class MusicOynatma extends BaseGameActivity
{
	...
	public Engine onLoadEngine() 
	{
        ...
        // ************************************ //
        // Music nesnesinin oynat�labilmesi i�in
	...
	public void onLoadResources() 
	{
		...
		// ************************************ //
		// Music nesnesi olu�turuluyor
		try 
		{
			if(music == null)
			{
				music = MusicFactory.createMusicFromAsset(this.mEngine.getMusicManager(), this, "gfx/oyunIciSeyirci.ogg");
			}
			else
			{
				music = null;
	...
	public Scene onLoadScene() 
	{
		...
		//***********************************//
		// Update metodu i�inde music nesnesini 
		// kontrol ederek oynat�yoruz.
